...
export default function Home() {
  return (
    <div>
      ...
      {/* By default, Tailwind CSS uses 0.25rem (4 pixels) as the base spacing unit. 
      So, space-x-10 would add a horizontal margin of 10 times the base spacing unit, 
      which is 2.5rem or 40 pixels. */}
